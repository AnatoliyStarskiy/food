...
window.addEventListener('DOMContentLoaded', () => {
  // Табы
  const tabs = document.querySelectorAll('.tabheader__item'); // получение псевдамасива с табами

  const tabsContent = document.querySelectorAll('.tabcontent'); // получение контента табов

  const tabsParent = document.querySelector('.tabheader__items'); // получение родителя табов
  ...
  const deadline = '2022-10-11'; // крайнее число
  ...
  } // функция установки времени на странице
  ...
  function setClock(selector, endtime) {
    ...
    updateClock(); // запускаем функцию, чтобы не мигала дата при обновлении страницы

    function updateClock() {
      const t = getTimeRemaining(endtime);
      days.innerHTML = getZero(t.days); // getZero добавляет 0 если одна цифра остается
  ...
  /* const cardOne = new MenuCard().render(); */
  ...
  new MenuCard('img/tabs/post.jpg', 'post', 'Меню "Постное"', 'Меню “Постное” - это тщательный подбор ингредиентов: полное отсутствие продуктов животного происхождения, молоко из миндаля, овса, кокоса или гречки, правильное количество белков за счет тофу и импортных вегетарианских стейков.', 430, '.menu .container', 'menu__item').render(); // Forms
