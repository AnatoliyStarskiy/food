...
function tabs(tabsSelector, tabsContentSelector, tabsPerentSelector, activeClass) {
    // Табы
    const tabs = document.querySelectorAll(tabsSelector); // получение псевдамасива с табами
    const tabsContent = document.querySelectorAll(tabsContentSelector); // получение контента табов
    const tabsParent = document.querySelector(tabsPerentSelector); // получение родителя табов
